	...
	public boolean equals(Shape shape) {
		if (shape instanceof Triangle) {
			...
			|| shape.posY!=this.posY) 
				return false;
			if (((Triangle)shape).point2.getPosX()!=this.point2.getPosX() 
			|| ((Triangle)shape).point2.getPosY()!=this.point2.getPosY()) 
				return false;
			if (((Triangle)shape).point3.getPosX()!=this.point3.getPosX() 
			|| ((Triangle)shape).point3.getPosY()!=this.point3.getPosY()) 
				return false;
			return true;
		}
		return false;
